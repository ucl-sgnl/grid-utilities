...
Sub Main
    ...
    SurferApp.GridData2(DataFile:="{dataFile}", _
        ...
        OutGrid:="{os.path.join(basePath, 'binary.grd')}")
    SurferApp.GridConvert("{os.path.join(basePath, 'binary.grd')}", "{basFile.replace('.BAS', '.grd')}", OutFmt:=srfGridFmtAscii)
End Sub
"""
