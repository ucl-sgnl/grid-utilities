...
component = 'Z';
mission = 'galileo_iov_v05';
grid_gen = 'galileo_iov_g3';
grids_folder = fullfile(pwd,'..',mission,'force_models','z_files');
eps_filename = fullfile(pwd,'..',mission,'force_models','galileo_iov_v05_eps_3960_1mm.txt');
...
save(fullfile(grids_folder,cat(2,grids_folder,'Spot4Errors',component,'Workspace.mat'))) % save workspace.
